...
fn material_to_rgba(t: u8) -> [f32; 4] {
    // Encode per-material highlight strength in alpha so shaders can boost bloom.
    let ((r, g, b), highlight) = match t {
        1 => ((0.25, 0.78, 0.28), 0.2),
        2 => ((1.25, 0.38, 0.32), 1.0),
        3 => ((0.28, 0.38, 1.05), 0.7),
        4 => ((1.15, 1.08, 0.36), 0.9),
        5 => ((1.30, 0.40, 1.20), 1.0),
        6 => ((0.42, 1.12, 1.18), 0.6),
        7 => ((0.55, 0.58, 0.62), 0.15),
        _ => ((1.0, 1.0, 1.0), 0.5),
    };
    [r, g, b, highlight]
}
